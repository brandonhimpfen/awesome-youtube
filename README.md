...
- [GetYouTubeTranscript](https://getyoutubetranscript.com/docs) — Free-tier REST API for transcripts, video/channel search, channel browsing, and playlists. Also available as an MCP server.
